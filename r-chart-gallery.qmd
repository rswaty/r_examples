...
## R chart gallery chart #1 for January 30th

* making histogram with base-R
...
# First distribution
hist(Ixos, breaks=30, 
     xlim=c(0,300),   # sets limit of x axis to 0 and 300
     col=rgb(1,0,0,0.5), 
     xlab="height", 
     ylab="nbr of plants", 
    main="distribution of height of 2 durum wheat varieties" )
